...
df = pd.read_csv("E:\VSCODE\GIT_Hub\myML\Proj1-GradientBoosting-MelbourneHousingPrice\Melbourne_housing_FULL\Melbourne_housing_FULL.csv")
...
##To find out the input variables for target
...
#Input variable adjusted for predicting the target
##Rooms: 1, Distance: 20, Bedroom: 3, Bathroom: 1, Car: 0, Landsize: 534, BuildingArea: 220,
#  YearBuilt: 1950, Suburb: Altona, CouncilArea: Hobsons Bay City Council, Type: h (house)
